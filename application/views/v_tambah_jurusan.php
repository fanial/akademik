...
<div class="wrapper">
  ...
  <div class="container">
       ...
       <form method="post" action="<?php echo base_url()?>jurusan/simpan_jurusan" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" required="required" class="form-control" id="kaprodi" name="kaprodi" placeholder="Kaprodi">
                <span class="help-block"></span>
            </div>
